...
class CountriesSeeder extends Seeder
{
    public function run()
    {
        $countries = [
            ...
            ['name' => 'Congo (Congo‑Kinshasa)', 'code' => 'COD'],
        ...
        Country::insertOrIgnore($data);

        $this->command->info(' Missing countries have been seeded successfully. Existing ones were skipped.');
    }
}