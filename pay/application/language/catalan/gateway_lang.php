...
$lang = [
    ...
    'online_payment_for_invoice'     => 'Pagament en línia per la factura',
    'online_payment_method'          => 'Mètode de pagament en línia',
    'online_payment_creditcard_hint' => 'Si vols pagar mitjançant targeta de crèdit, si us plau, introdueix la informació a continuació.<br/>Les dades de la targeta de crèdit no s\'emmagatzemen als nostres servidors i es transferiran a la passarel·la de pagament en línia fent servir una connexió segura.',
    'enable_online_payments'         => 'Permetre els pagaments en línia',
    'payment_provider'               => 'Proveïdor de pagament',
    'provider_response'              => 'Resposta del proveïdor',
    'add_payment_provider'           => 'Afegir un proveïdor de pagament',
    'transaction_reference'          => 'Referència de la transacció',
    'transaction_successful'         => 'Transacció amb èxit',
    ...
    'online_payment_card_invalid' => 'Aquesta targeta de crèdit no és vàlida. Si us plau, comprova la informació proporcionada.',
    ...
    'online_payment_websiteKey'          => 'Clau del lloc web', // Field for Buckaroo_Ideal
    ...
    'online_payment_merchantKey'         => 'Clau del minorista', // Field for PayFast
    ...
    'online_payment_referrerId'          => 'ID del recomanador', // Field for SagePay_Direct
    ...
    'online_payment_installationId'      => 'ID de la instal·lació', // Field for WorldPay
    'online_payment_callbackPassword'    => 'Contrasenya de la resposta (callback)', // Field for WorldPay

    // Status / Error Messages
    'online_payment_payment_cancelled'  => 'Pagament cancel·lat.',
    'online_payment_payment_failed'     => 'No s\'ha pogut fer el pagament. Torna-ho a provar.',
    ...
    'online_payment_3dauth_redirect'    => 'Si us plau, espera mentre et redirigim a l\'emissor de la teva targeta per a l\'autenticació...',
];
