...
<div class="anim-fade-up" id="mainContent" style="opacity: 0; transition: opacity 0.5s ease;">
    ...
    <div class="top-bar" style="margin-top: 1rem;">
        <div>
            <h2 class="page-title" style="font-size: 1.5rem; margin-bottom: 0.3rem;">إنشاء منشأة جديدة</h2>
            <p style="color: var(--text-muted); font-size: 0.9rem; font-weight: 500;">أدخل معلومات المنشأة الأساسية للبدء</p>
        </div>
    ...
    <div class="panel anim-fade-up anim-delay-1" style="max-width: 900px;">
        <form action="{{ route('business-owner.business.store') }}" method="POST" id="businessForm">
            @csrf
                    ...
                    <div class="custom-select" id="businessTypeSelect">
                        ...
                        <div class="custom-options">
                            ...
                            @foreach($businessTypes as $type)
                                <div class="custom-option {{ old('business_type_id') == $type->id ? 'selected' : '' }}"
                                     data-value="{{ $type->id }}">
                                    <div class="option-content">
                                        <span class="option-text">{{ $type->name }}</span>
                                        @if(old('business_type_id') == $type->id)
                        ...
                        <div class="custom-select" id="countrySelect">
                            ...
                            <div class="custom-options">
                                ...
                                @foreach($countries as $country)
                                    <div class="custom-option {{ old('country_id') == $country->id ? 'selected' : '' }}"
                        ...
                        <div class="custom-select" id="citySelect">
                            ...
                            <div class="custom-options">
                                ...
                                @foreach($cities as $city)
                                    <div class="custom-option {{ old('city_id') == $city->id ? 'selected' : '' }}"
                                         data-value="{{ $city->id }}">
                                        <div class="option-content">
            ...
            <div style="display: flex; gap: 0.9rem; margin-top: 2.5rem; padding-top: 1.8rem; border-top: 1px solid var(--border-light);">
                <button type="submit" class="btn-primary" style="padding: 0.8rem 2.2rem; font-size: 0.9rem;">
                    <i class="fa-solid fa-circle-plus"></i> إنشاء المنشأة
                </button>
