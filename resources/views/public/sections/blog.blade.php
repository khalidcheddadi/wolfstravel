...
<section class="blog-section" style="direction: ltr;" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
    <div class="blog-container">

        <div class="blog-header">
            <span class="blog-sub-title" data-aos="fade-down" data-aos-duration="600">{{ __('messages.blog_tips') }}</span>
            <h2 class="blog-main-title" data-aos="fade-up" data-aos-delay="150" data-aos-duration="700">{{ __('messages.blog_latest_posts') }}</h2>
            <p class="blog-description" data-aos="fade-up" data-aos-delay="300" data-aos-duration="700">{{ __('messages.blog_description') }}</p>
        </div>
                ...
                <a href="{{ route('posts.show', $post->slug) }}" style="text-decoration: none; color: inherit; display: block;">
                    <div class="blog-card"
                        ...
                        <div class="blog-card-content">
                            <span class="blog-category">{{ $post->category->name ?? __('messages.uncategorized') }}</span>
                            <h3 class="blog-card-title">{{ $post->title }}</h3>
                            <div class="blog-author">
                                <i class="fa-regular fa-user"></i>
                                {{ __('messages.blog_by_author', ['author' => $post->user->name ?? 'Admin']) }}
