    ...
    <div class="auth-layout">
        ...
        <div class="auth-image">
            <div class="auth-image-content">
                ...
                <h1 class="auth-image-title">No te preocupes,<br>estamos aquí para ayudarte</h1>
                <p class="auth-image-desc">
                    Introduce tu correo electrónico y te enviaremos un enlace para restablecer tu contraseña en minutos.
                </p>
                <div class="auth-image-features">
                    <div class="auth-image-feature">
                        <span><i class="fa-solid fa-check"></i></span>
                        Enlace rápido en menos de un minuto
                    </div>
                    <div class="auth-image-feature">
                        <span><i class="fa-solid fa-check"></i></span>
                        Correo electrónico seguro y encriptado
                    </div>
                    <div class="auth-image-feature">
                        <span><i class="fa-solid fa-check"></i></span>
            ...
            <div class="auth-form-inner">
                ...
                <div class="auth-form-header">
                    ...
                    <p class="auth-form-subtitle">
                        No te preocupes, introduce tu correo electrónico y te ayudaremos a recuperarla.
                    </p>
                </div>
